    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for pos in self.legalPositions:
            ...
            for newPos, prob in newPosDist.items():
                belief[newPos] += self.beliefs[pos] * prob
...
class JointParticleFilter:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            for i in range(self.numGhosts):
                newParticlePos = getPositionDistributionForGhost(setGhostPositions(gameState,
                                                                               list(oldParticle)),
                                                             i,
                                                             self.ghostAgents[i])
                newParticle[i] = util.sampleFromCounter(newParticlePos)
