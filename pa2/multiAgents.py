...
def betterEvaluationFunction(currentGameState):
    """
      ...
      Also I have made sure that winning is the primary goal of the PacMan by assigning infinity points on winning
      and vice versa for the losing game.
...
#     util.raiseNotDefined()
    ...
    for agentIndex in range(currentGameState.getNumAgents()):
        if agentIndex != pIndex:
            nextdist = util.manhattanDistance(currentGameState.getPacmanPosition(),
                                              currentGameState.getGhostPosition(agentIndex))
